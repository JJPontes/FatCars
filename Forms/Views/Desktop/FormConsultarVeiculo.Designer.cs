namespace Forms
{
	partial class FormConsultarVeiculo
	{
		...
		private void InitializeComponent()
		{
			...
			this.pIM1DataSet1 = new Forms.PIM1DataSet1();
			this.lblFiltro = new System.Windows.Forms.Label();
			this.txtPesquisar = new System.Windows.Forms.TextBox();
			this.button1 = new System.Windows.Forms.Button();
			this.ComboFiltro = new System.Windows.Forms.ComboBox();
			this.tableLayoutPanel1 = new System.Windows.Forms.TableLayoutPanel();
			this.pIM1DataSet = new Forms.PIM1DataSet();
			this.pIM1DataSetBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.tB_CarrosTableAdapter = new Forms.PIM1DataSet1TableAdapters.TB_CarrosTableAdapter();
