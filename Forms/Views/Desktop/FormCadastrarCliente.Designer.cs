namespace Forms
{
	partial class FormCadastrarCliente
	{
		...
		private void InitializeComponent()
		{
			...
			this.maskedEmitida.TabIndex = 13;
			...
			this.maskedValidade.TabIndex = 14;
			...
			this.txtTelCom.TabIndex = 8;
			this.txtTelCom.TextMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			// 
			// lblTelCom
			// 
			...
			this.tabMultas.Controls.Add(this.maskedData);
			...
			// btnSalvarMulta
			// 
			this.btnSalvarMulta.Location = new System.Drawing.Point(353, 75);
			...
			this.comboPlaca.Location = new System.Drawing.Point(207, 79);
			...
			// txtNrPontos
			// 
			this.txtNrPontos.Location = new System.Drawing.Point(129, 79);
			...
			// txtValor
			// 
			this.txtValor.Location = new System.Drawing.Point(3, 79);
			...
			// maskedData
			// 
			this.maskedData.HidePromptOnLeave = true;
			this.maskedData.Location = new System.Drawing.Point(3, 37);
			this.maskedData.Mask = "00/00/0000";
			this.maskedData.Name = "maskedData";
			this.maskedData.Size = new System.Drawing.Size(100, 20);
			this.maskedData.TabIndex = 1;
