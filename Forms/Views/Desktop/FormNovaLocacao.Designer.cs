namespace Forms
{
	partial class FormNovaLocacao
	{
		...
		private void InitializeComponent()
		{
			...
			this.maskedHoraRetirada.MaskInputRejected += new System.Windows.Forms.MaskInputRejectedEventHandler(this.maskedHoraRetirada_MaskInputRejected);
			// 
			// maskedHoraDevolucao
			// 
			...
			this.lblValorSegRoubo.Click += new System.EventHandler(this.LblValorSegRoubo_Click);
			// 
			// checkSegTerceiros
			// 
			...
			this.lblValorSeguro.Click += new System.EventHandler(this.lblValorSeguro_Click);
			// 
			// label13
			// 
