namespace WindowsFormsApp1.Views.Desktop
{
	partial class FormControlePatio
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Text = "Registro de Saída do pátio";
			// 
			// maskedTextBox2
			// 
			...
			// maskedTextBox1
			// 
			this.maskedTextBox1.Location = new System.Drawing.Point(9, 42);
			...
			// richTextBox1
			// 
			this.richTextBox1.Location = new System.Drawing.Point(9, 120);
			...
			this.groupBox2.Controls.Add(this.lblKmRodado);
			this.groupBox2.Controls.Add(this.label8);
			this.groupBox2.Controls.Add(this.comboBox1);
			this.groupBox2.Controls.Add(this.label7);
			this.groupBox2.Controls.Add(this.txtkmRetorno);
			this.groupBox2.Controls.Add(this.label5);
			this.groupBox2.Location = new System.Drawing.Point(379, 209);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(341, 217);
			this.groupBox2.TabIndex = 5;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "Registro de retorno ao pátio";
			// 
			// textBox1
			// 
			...
			// maskedTextBox4
			// 
			this.maskedTextBox4.Location = new System.Drawing.Point(9, 42);
			...
			this.lblKmRodado.Location = new System.Drawing.Point(168, 165);
			...
			this.lblKmRodado.Click += new System.EventHandler(this.label9_Click);
			// 
			// label8
			// 
			...
			this.txtkmRetorno.Size = new System.Drawing.Size(100, 20);
			...
			this.groupBox3.Text = "Veículos fora do pátio";
			// 
			// dataGridView1
			// 
			...
			// groupBox4
			// 
			this.groupBox4.Controls.Add(this.btnAddCarro);
			this.groupBox4.Controls.Add(this.btnAddMotorista);
			...
			this.groupBox4.Size = new System.Drawing.Size(361, 159);
			this.groupBox4.TabIndex = 8;
			this.groupBox4.TabStop = false;
			this.groupBox4.Text = "Registro do carro:";
			// 
			// btnAddCarro
			// 
